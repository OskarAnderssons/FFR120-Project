...
FUTURE_MAX = 3 #Max future time for prediction
WINDOWS_SIZE = 750
        ...
        if self.cooldown > 0:
            ...
            if closest_fish:
                ...
                if USE_DELAY:
                    ...
                    predicted_x = px[0] * (DELAY_TIME+future_time) + px[1]
                    predicted_y = py[0] * (DELAY_TIME+future_time) + py[1]

                    # predicted_x = fish_position_x[closest_index,DELAY_TIME-1] + px[0]*future_time
                    # predicted_y = fish_position_y[closest_index,DELAY_TIME-1] + py[0]*future_time
